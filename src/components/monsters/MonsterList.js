        ...
        if (this.props.monsters) {
            ...
            return (
                <div>
                    ...
                    <p>Notice that the XP shown is a relative to the level difference between the enemy and the player. The XP will also be greater in parties or if a <Link to="/items/18020">Realm XP Event</Link> is active.</p>
